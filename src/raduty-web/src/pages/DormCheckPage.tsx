...
export function DormCheckPage() {
  ...
  return <div className="page dorm-check-page">
    <header className="dorm-check-heading">
      <div><span className="eyebrow">Eltse Hall</span><h1>Room checks</h1><p>Select a room, complete the checklist, and submit it under your name.</p></div>
    ...
    {suites.isError && <ErrorState title="Room checks unavailable" message={suites.error instanceof ApiError ? suites.error.problem.title : 'The suite list could not be loaded.'} onRetry={() => suites.refetch()} />}
