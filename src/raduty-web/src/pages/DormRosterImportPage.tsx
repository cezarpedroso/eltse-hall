...
export function DormRosterImportPage() {
  ...
  return <div className="page roster-import-page">
    ...
    {preview && <section className="roster-analysis" aria-labelledby="roster-analysis-title">
      ...
      {preview.canApply && changeCount > 0 && !applied && <div className="roster-apply-bar"><div><strong>Ready to update Eltse Hall</strong><span>Room checks stay attached to their rooms.</span></div><button type="button" className="button button--primary" onClick={() => setConfirmApply(true)}>Apply roster changes</button></div>}
    </section>}
